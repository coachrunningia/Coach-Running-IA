    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[100] animate-in fade-in">
        ...
        <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
                <h4 className="font-bold text-blue-800 mb-2">Recommandation d'adaptation</h4>
                <p className="text-sm text-blue-700">Souhaitez-vous adapter la semaine prochaine en fonction de cette fatigue/performance ?</p>
                <div className="flex gap-3 mt-3">
                <button className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-700">Oui, adapter le plan</button>
                <button className="bg-white text-blue-600 border border-blue-200 px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-50">Non, garder le cap</button>
                </div>
            </div>
        </div>
        ...
        <button
            onClick={onClose}
            className="mt-8 w-full px-6 py-3 bg-slate-100 text-slate-700 rounded-lg font-bold hover:bg-slate-200 transition-colors"
        >
            Fermer
        </button>
        </div>
