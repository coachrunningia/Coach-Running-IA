globalThis.__IMPORT_META_ENV__ = { VITE_R2_GATES_ENABLED: 'true', VITE_GEMINI_API_KEY: 'TEST_FAKE_KEY_NOT_USED', PROD: false, DEV: true, MODE: 'development' };
...
\u{1F6B6} IMPORTANT - NIVEAU D\xC9BUTANT D\xC9TECT\xC9 :
...
EFFORT PER\xC7U dans chaque mainSet (OBLIGATOIRE) : Jogging/SL = "4/10, conversation facile" | Fartlek = "6-7/10 sur acc\xE9l\xE9rations, retour 4/10 entre" | R\xE9cup = "3/10, tr\xE8s tr\xE8s facile".
...
\u{1F6B6} PROGRESSION MARCHE/COURSE POUR D\xC9BUTANT :
...
\u{1F534} CHAQUE semaine doit avoir ${data.frequency} s\xE9ances.
\u{1F534} Jours : ${data.preferredDays?.length ? data.preferredDays.join(", ") + " \u2014 CES JOURS UNIQUEMENT." : "R\xE9partition \xE9quilibr\xE9e."}
